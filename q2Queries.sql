...
SELECT DISTINCT StudentId FROM high_gpa_no_fail WHERE HIGHGPA > %1% ORDER BY StudentId;
...
SELECT 0;
SELECT DISTINCT StudentId, COUNT(StudentID) FROM ExcellentStudents2018Q1 GROUP BY StudentId HAVING COUNT(StudentId) >= 3;
